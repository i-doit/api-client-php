...
class CategoryStatusTest extends BaseTest {
    ...
    public function testArchiveSingleValueCategory() {
        ...
        $this->isID($entryID);
        $this->isNormalEntry($objectID, Category::CATG__MODEL, $entryID);

        $result = $this->useCMDBCategory()->archive($objectID, Category::CATG__MODEL, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isArchivedEntry($objectID, Category::CATG__MODEL, $entryID);
    }
    ...
    public function testArchiveMultiValueCategoryEntry() {
        ...
        $this->isID($entryID);
        $this->isNormalEntry($objectID, Category::CATG__IP, $entryID);

        $result = $this->useCMDBCategory()->archive($objectID, Category::CATG__IP, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isArchivedEntry($objectID, Category::CATG__IP, $entryID);
    }
    ...
    public function testArchiveDeletedSingleValueCategory() {
        ...
        $result = $this->useCMDBCategory()->delete($objectID, Category::CATG__MODEL, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isDeletedEntry($objectID, Category::CATG__MODEL, $entryID);
    ...
    public function testArchiveDeletedEntryInMultiValueCategory() {
        ...
        $result = $this->useCMDBCategory()->delete($objectID, Category::CATG__IP, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isDeletedEntry($objectID, Category::CATG__IP, $entryID);
    ...
    public function testArchivePurgedSingleValueCategory() {
        ...
        $result = $this->useCMDBCategory()->purge($objectID, Category::CATG__MODEL, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isNotAvailable($objectID, Category::CATG__MODEL, $entryID);
    ...
    public function testArchivePurgedEntryInMultiValueCategory() {
        ...
        $result = $this->useCMDBCategory()->purge($objectID, Category::CATG__IP, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isNotAvailable($objectID, Category::CATG__IP, $entryID);
...
//    }
    ...
    public function testRecycleSingleValueCategory() {
        ...
        $result = $this->useCMDBCategory()->recycle($objectID, Category::CATG__MODEL, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isNormalEntry($objectID, Category::CATG__MODEL, $entryID);
    }
    ...
    public function testRecycleEntryInMultiValueCategory() {
        ...
        $result = $this->useCMDBCategory()->recycle($objectID, Category::CATG__IP, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isNormalEntry($objectID, Category::CATG__IP, $entryID);
    }
...
//    }
    ...
    public function testClear() {
        ...
        // Check:
        $entries = $this->useCMDBCategory()->read($objectID, Category::CATG__IP, 2);

        $this->assertIsArray($entries);
        $this->assertCount(0, $entries);

        $entries = $this->useCMDBCategory()->read($objectID, Category::CATG__CONTACT, 2);
    ...
    public function testClearWithMixedStates() {
        ...
        // Run tests:
        $result = $this->useCMDBCategory()->clear($objectID, [Category::CATG__IP]);
    ...
    public function testQuickPurge() {
        ...
        $result = $this->useCMDBCategory()->quickPurge($objectID, Category::CATG__IP, $entryID);
        $this->assertInstanceOf(CMDBCategory::class, $result);
        $this->isNotAvailable($objectID, Category::CATG__IP, $entryID);
    }
